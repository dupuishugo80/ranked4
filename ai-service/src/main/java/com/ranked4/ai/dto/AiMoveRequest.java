...
public record AiMoveRequest(
    ...
    @Pattern(regexp = "^[012]{42}$", message = "Grid must be 42 characters of 0, 1, or 2")
    String grid,
    ...
    @Min(value = 1, message = "AI player ID must be 1 or 2")
    @Max(value = 2, message = "AI player ID must be 1 or 2")
    int aiPlayerId
) {}
